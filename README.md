...
| Package                                                            | What it is                                                                              |
| ------------------------------------------------------------------ | --------------------------------------------------------------------------------------- |
| [`packages/injest`](packages/injest/README.md)                     | The test runner: CLI + agent test API (`injest/agent`). **Start here.**                 |
...
each package extends it. The extension depends on the local `injest` so it runs against
your in-tree build.
